...
export const en = {
  ...
  mcp: {
    ...
    add: {
      ...
      clientIdHint: 'Only needed for servers that do not support dynamic client registration — GitHub and Slack require a client you registered with them beforehand.',
      clientIdRequiredHint: 'This server requires a pre-registered OAuth client. Enter its OAuth client ID above and add it again.',

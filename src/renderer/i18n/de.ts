...
export const de: Dict = {
  ...
  mcp: {
    ...
    add: {
      ...
      urlHint: 'Akzeptiert einen entfernten MCP-Endpunkt oder eine Registry-/Server-Manifest-URL. Eine Registry-URL ist meist die bessere Wahl: Der Server läuft gekapselt im MCP-Gateway und authentifiziert sich mit Ihrem eigenen Konto-Token statt über eine OAuth-Client-Registrierung.',
      clientIdLabel: 'OAuth-Client-ID (optional)',
      clientIdPlaceholder: 'Iv1.0123456789abcdef',
      clientIdHint: 'Nur für entfernte Endpunkte, die einen zuvor beim Anbieter registrierten Client verlangen. Bei einer Registry-URL leer lassen.',
      clientIdRequiredHint: 'Dieser Endpunkt unterstützt keine dynamische Client-Registrierung. Fügen Sie den Server stattdessen über seine Registry-URL hinzu — der übliche Weg für GitHub, der dann Ihr eigenes Konto-Token nutzt — oder tragen Sie oben eine vorab registrierte OAuth-Client-ID ein.',
      metadataUrlLabel: 'Metadaten-URL',
      metadataUrlPlaceholder: 'https://example.com/metadata.json',
      commandLabel: 'Befehl',
      commandPlaceholder: '/usr/local/bin/npx',
      argsLabel: 'Argumente (optional)',
      argsPlaceholder: '-y @modelcontextprotocol/server-github',
      warningTitle: 'Hostzugriff — keine Sandbox-Isolierung',
      warningBody: 'Dieser Server läuft als Prozess auf Ihrem Host-Rechner, außerhalb des Sandbox-Containers. Er hat dieselben Rechte wie Ihr Benutzerkonto.',
      ackLabel: 'Mir ist bewusst, dass dieser Server auf dem Host ohne Sandbox-Isolierung läuft.',
      submit: 'Hinzufügen',
      errNameRequired: 'Name ist erforderlich.',
      errNameDuplicate: 'Ein Server namens „{name}“ ist bereits registriert.',
      errUrlInvalid: 'Geben Sie eine gültige https://-URL ein.',
      errCommandRequired: 'Befehl ist erforderlich.',
      errAckRequired: 'Bestätigen Sie den Hostzugriff, bevor Sie diesen Server hinzufügen.',
      addFailed: 'Server konnte nicht hinzugefügt werden: {message}'
    },
    colName: 'Name',
    colType: 'Typ',
    ...
    inspect: 'Details',
    back: 'Zurück',
    transport: { remote: 'Remote', local: 'Lokal', command: 'Lokal (stdio)', server: 'Registry (isoliert)' },
  ...
  credentials: {
    ...
    host: 'Host / Domäne',
    hostInvalid: '„{host}“ ist kein verwendbarer Host. Geben Sie einen reinen Host, eine IP oder einen Platzhalter an — zum Beispiel api.example.com oder *.example.com (ohne https://, Port oder Pfad).',
    envVar: 'Umgebungsvariable',
    envVarTaken: 'Diese Umgebungsvariable wird bereits von einem anderen benutzerdefinierten Geheimnis in dieser Definition verwendet. Jedes benötigt einen eigenen Namen. Um mehrere Domänen mit EINEM Geheimnis zu erreichen, tragen Sie sie alle im Feld „Host / Domäne“ dieses Eintrags ein, durch Kommas getrennt.',
    wildcardHint: 'Trennen Sie mehrere Domänen durch Kommas, um sie alle mit einem Geheimnis zu erreichen (accounts.google.com, oauth2.googleapis.com). Unterstützt Platzhalter (*.example.com, **.example.com). Der Proxy ersetzt Ihren Wert überall dort, wo die Umgebungsvariable in Anfragen an diese Hosts erscheint — der Agent sieht das echte Geheimnis nie.',
  ...
  wizard: {
    ...
    steps: { workspace: 'Arbeitsverzeichnis', baseImage: 'Basis-Image', network: 'Netzwerk', ports: 'Ports', credentials: 'Anmeldedaten', mcp: 'MCP-Server', advanced: 'Erweitert', review: 'Überprüfung' },
    ...
    cpusMaxHint: 'Max. {cores} Kerne auf diesem Host · leer lassen, um alle Host-CPUs zu nutzen.',
    cpusExceedsMax: 'Dieser Host hat {cores} CPU-Kerne. {cores} oder weniger eingeben oder leer lassen für den Standard.',
    ...
    memoryHostHint: 'Host-Speicher: {total} GB · sbx nutzt standardmäßig 50 % des Host-Speichers, max. 32 GiB.',
    ...
    add: 'Hinzufügen',
    mcpTitle: 'MCP-Server',
    mcpSubtitle: 'Wählen Sie, wie diese Sandbox über das Docker-Sandboxes-Gateway mit MCP-Servern verbunden wird.',
    mcpMode: { off: 'Aus', dynamic: 'Dynamisch', static: 'Statisch' },
    mcpModeOffDesc: 'Dem Agenten werden keine MCP-Server bereitgestellt.',
    mcpModeDynamicDesc: 'Der Agent kann jeden registrierten MCP-Server erkennen und nutzen.',
    mcpModeStaticDesc: 'Nur die unten ausgewählten Server werden dem Agenten bereitgestellt.',
    mcpEmptyRegistry: 'Noch keine MCP-Server registriert. Fügen Sie einen über den Bildschirm „MCP-Server“ hinzu, um die statische Bindung zu aktivieren.',
    mcpNeedsAuthNudge: 'Server, die eine Autorisierung benötigen, können weiterhin ausgewählt werden — fügen Sie jederzeit Anmeldedaten über den Bildschirm „MCP-Server“ hinzu.',
    mcpAgentUnsupported: '{agent} unterstützt MCP noch nicht — diese Konfiguration wird gespeichert, hat aber keine Wirkung, bis Unterstützung hinzugefügt wird.',
    reviewMcp: 'MCP-Server',
    review: 'Überprüfung',

...
export const de: Dict = {
  ...
  mcp: {
    ...
    add: {
      ...
      clientIdHint: 'Nur nötig für Server ohne dynamische Client-Registrierung — GitHub und Slack verlangen einen zuvor bei ihnen registrierten Client.',
      clientIdRequiredHint: 'Dieser Server benötigt einen vorab registrierten OAuth-Client. Tragen Sie oben dessen OAuth-Client-ID ein und fügen Sie ihn erneut hinzu.',

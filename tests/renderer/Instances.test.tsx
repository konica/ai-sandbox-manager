...
const rows: InstanceView[] = [
  { name: 'sbx-a', status: 'running', agent: 'claude', workspace: '/w', ports: ['127.0.0.1:8080->3000/tcp'], definitionId: 'd1', definitionName: 'prj-alpha', tier: 'locked', tags: [], createdAt: null }
]
